...
class Choices(object):
	...
	FOLLOW_STATUS = (
			(Constants.OK,'Ok'),
			(Constants.BLOCKED, _('Blocked')),
			(Constants.UNBLOCKED, _('UnBlocked')),
			)
	# CONTACT_SOURCE
	CONTACT_SOURCE = (
			(Constants.TWITTER,'Twitter'),
			(Constants.FACEBOOK,'Facebook'),
			(Constants.LINKEDIN,'LinkedIn'),
			(Constants.IMPORT, _('Imported')),
			(Constants.GMAIL,'Gmail'),
			(Constants.YAHOO,'Yahoo'),
			(Constants.MSN,'MSN'),
			)
	# ADDRESS_TYPE
	...
	CONTACT_COMM = (
		(Constants.EMAIL, 'Email'),
		(Constants.HOME, _('Home Phone')),
		(Constants.WORK, _('Work Phone')),
		(Constants.MOBILE, _('Mobile')),
		(Constants.WORK_MOBILE, _('Work Mobile')),
		(Constants.FAX, 'Fax'),
		(Constants.NETWORK, _('Social Network')),
		(Constants.SITE, _('Site')),
		(Constants.BLOG, _('Blog')),
		(Constants.FACEBOOK_PAGE, _('Facebook Page')),
		(Constants.IM, _('Instant Messenger')),
		)
	# MILITARY
	MILITARY_NA = 'na'
	...
	# INVITATION STATUS
	INVITATION_STATUS = (
		(Constants.PENDING, _('Pending')),
		(Constants.USED, _('Used')),
			)
	# CALENDAR TYPE
	...
	CALENDAR_INVITE_STATUS_PENDING = Constants.PENDING
	CALENDAR_INVITE_STATUS = (
		(Constants.PENDING, _('Pending')),
		('accepted', _('Accepted')),
		('declined', _('Declined')),
