# -*- coding: utf-8 -*-
#
# Ximpia documentation build configuration file, created by
...
sys.path.insert(0, '../../ximpia-env/lib/python2.7/site-packages')
...
latex_documents = [
  ('index', 'Ximpia.tex', u'Ximpia Documentation',
   u'Jorge', 'manual'),
]
...
man_pages = [
    ('index', 'ximpia', u'Ximpia Documentation',
     [u'Jorge Alegre'], 1)
]
...
texinfo_documents = [
  ('index', 'Ximpia', u'Ximpia Documentation',
   u'Jorge', 'Ximpia', 'One line description of project.',
   'Miscellaneous'),
]
