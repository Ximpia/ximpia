...
ximpia.external.Facebook.renderSignup = (function( attrs, callable ) {
	...
	// Facebook button
	FB.init({appId: ximpia.settings.FACEBOOK_APP_ID, status: true, cookie: true, xfbml: true});
...
ximpia.external.Captcha.renderCaptcha = (function( attrs, callable ) {
	...
	Recaptcha.create(ximpia.settings.RECAPTCHA_PUBLIC_KEY,
	    "id_recaptcha_comp",
	    {
	      theme: "clean",
	      callback: function() {
				...
				try {
					...
					if (obj.winType == 'popup') {
						ximpia.console.log('getView() :: Will open popup...');
	        				var obj = {isPopupReqView: true, view: obj.view, params: obj.params, app: obj.app};
