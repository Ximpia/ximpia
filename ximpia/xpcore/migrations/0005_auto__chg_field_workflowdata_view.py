...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('CORE_WORKFLOW_DATA', 'ID_VIEW', self.gf('django.db.models.fields.related.ForeignKey')(db_column='ID_VIEW', to=orm['xpcore.View'], null=True))

    def backwards(self, orm):

        # Changing field 'WorkflowData.view'
        db.alter_column('CORE_WORKFLOW_DATA', 'ID_VIEW', self.gf('django.db.models.fields.related.ForeignKey')(default='', db_column='ID_VIEW', to=orm['xpcore.View']))
    ...
    models = {
        ...
        u'xpcore.workflowdata': {
            ...
            'userModifyId': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'db_column': "'USER_MODIFY_ID'", 'blank': 'True'}),
            'view': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'viewFlowData'", 'db_column': "'ID_VIEW'", 'default': "''", 'to': u"orm['xpcore.View']", 'blank': 'True', 'null': 'True'})
        },
        ...
        u'xpcore.workflowview': {
            ...
            'hasEvent': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'db_column': "'HAS_EVENT'"}),
