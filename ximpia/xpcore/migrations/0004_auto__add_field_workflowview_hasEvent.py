...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WorkflowView.hasEvent'
        db.add_column('CORE_WORKFLOW_VIEW', 'hasEvent',
                      self.gf('django.db.models.fields.BooleanField')(default=True, db_column='HAS_EVENT'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WorkflowView.hasEvent'
        db.delete_column('CORE_WORKFLOW_VIEW', 'HAS_EVENT')
